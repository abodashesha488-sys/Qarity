...
class HeritageScreen extends StatelessWidget {
  ...
  static const _items = [
    _SubItem('تراث القرية', Icons.home_rounded, Color(0xFF7B1FA2), 'تاريخ وموروث'),
    _SubItem('الأمهات العربيات', Icons.family_restroom_rounded, Color(0xFF4CAF50), 'نساء قويات'),
    _SubItem('الطب التراثي', Icons.local_hospital_rounded, Color(0xFF2196F3), 'علاجات قديمة'),
    _SubItem('الحرف الشعبية', Icons.handyman_rounded, Color(0xFFFF9800), 'صناعات وصناع'),
  ];
